...
public class Drive extends Subsystem {
    ...
    private Drive() {
        ...
        velocityHeadingPid_.setOutputRange(-60,60);//-30, 30);

        setOpenLoop(DriveSignal.NEUTRAL);
    }

    public static TalonSRX tuneLoops(TalonSRX talon, int id, double P, double I, double D, double F,int Izone,double Ramp){
   ...
   /* public void setHighGear(boolean high_gear) {
    ...
    /**
     * Controls whether the brake is on or not.
     */
